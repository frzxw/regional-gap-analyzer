...
export function InflasiTahunanManualForm() {
    ...
    const handleSubmit = useCallback(
        async (e: React.FormEvent) => {
            ...
            try {
                ...
                const response = await fetch(`${API_BASE}/api/v1/inflasi-tahunan`, {
                    method: "POST",
                ...
                toast({
                    title: "Berhasil!",
                    description: "Data Inflasi Tahunan berhasil disimpan",
                });
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            <div className="p-4 bg-blue-500/10 border border-blue-500/30 rounded-lg flex items-start gap-3">
                ...
                <div className="text-sm">
                    <p className="font-medium text-blue-500">Input Manual Inflasi Tahunan</p>
                    <p className="text-muted-foreground mt-1">
                        Masukkan nilai Inflasi (%) per bulan dan nilai tahunan.
                    </p>
                </div>
            </div>
            ...
            <Card>
                <CardHeader>
                    <CardTitle className="text-base">Data Bulanan Inflasi (%)</CardTitle>
                    <CardDescription>Tingkat inflasi per bulan</CardDescription>
                </CardHeader>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Nilai inflasi tahunan (%)</CardDescription>
                </CardHeader>
                <CardContent>
                    <div className="space-y-2">
                        <Label htmlFor="tahunan">Inflasi Tahunan</Label>
                        <Input
                            id="tahunan"
                            type="number"
                            step="0.01"
